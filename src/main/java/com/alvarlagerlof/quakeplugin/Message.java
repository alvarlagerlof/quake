...
import com.alvarlagerlof.quakeplugin.DefaultFontInfo;
...
public class Message {
    ...
    public void sendToPlayerGroup(Server server, List<Player> players, Boolean sendQuake, String color, String message) {
        if (sendQuake) {
